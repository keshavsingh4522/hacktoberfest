...
#include<vector>
using namespace std;
void maxheapify(vector<int> &x,int index,int heapsize)
{
...
if (largest != index)
{
    ...
    maxheapify(x,largest,heapsize);
}

}

void builmaxheap (vector<int> &x)
{
int n = (x.size()-1)/2 ;

for(int i = n; i >=1  ; i--)
maxheapify(x,i,x.size()-1);
