# The famous Wheel of Fortune Game using python
# I only made the class objects: WOFPlayer, WOFHumanPlayer, WOFComputerPlayer. Other sections were provided by coursera learner course
VOWEL_COST = 250
...
class WOFHumanPlayer(WOFPlayer):
    def getMove(self, category, obscuredPhrase, guessed):
        ...
        print("{} has ${} Category: {} Phrase:  {} Guessed: {} Guess a letter, phrase, or type 'exit' or 'pass':".format(self.name, self.prizeMoney, category, obscuredPhrase, guessed))
        usr = input()
        return usr
...
class WOFComputerPlayer(WOFPlayer):
    ...
    def getPossibleLetters(self, guessed):
        if self.prizeMoney > VOWEL_COST:
            ...
            return [i for i in LETTERS if i not in guessed and i not in VOWELS]
    
    def getMove(self, category, obscuredPhrase, guessed):
        a = self.getPossibleLetters(guessed)
        if len(a) == 0:
            return 'pass'
        ...
        if self.smartCoinFlip() == True:
            temp = 0
            for i in a:
                temp = max(temp, self.SORTED_FREQUENCIES.index(i))
            return self.SORTED_FREQUENCIES[temp]
        else:
