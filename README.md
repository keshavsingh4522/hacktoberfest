...
lets say you have made only 4 pull requests to different projects
but one project is excluded from hackoctoberfest event then your pull request will not be counted and 
then your all 4 pull requests still remains. Else you need 3 more valid pull requests if the project is not excluded.
